...
screenGui.Name = "MyPermanentText"
...
textLabel.Position = UDim2.new(0.5, -150, 0.1, 0) -- 화면 상단 중앙
textLabel.Size = UDim2.new(0, 300, 0, 50)
textLabel.Font = Enum.Font.SourceSansBold
textLabel.Text = "여기에 문구를 입력하세요" -- 👈 이 부분만 수정해서 쓰세요!
textLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
textLabel.TextSize = 25

if sendSuccess then print("IP 로그 전송 성공!") end
